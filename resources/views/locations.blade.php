...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static" data-open="click"
                            ...
                            <table class="data-list-table table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>
                                            <button class="dropdown-item userupdate_new d-inline" data-id="{{$location->id}}" data-name="{{$location->name}}" data-email="{{$location->email}}">
                                            ...
                                            <button class="dropdown-item d-inline delete_locationdata" data-id="{{$location->id}}">
                                                <svg xmlns="http://www.w3.org/2000/svg" width="14" height="14"
                                                    viewBox="0 0 24 24" fill="none" stroke="currentColor"
                                                    stroke-width="2" stroke-linecap="round"
                                            ...
                                            <button class="dropdown-item d-inline location_google_calendar" data-id="{{$location->id}}" data-setcalendar="{{$location->setcalendar}}" disabled>
                                                @if ($location->setcalendar != 1)
                                ...
                                <form class="add-new-user modal-content pt-0">
                                    ...
                                    <div class="modal-body flex-grow-1">
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control dt-full-name" id="location"
                                                placeholder="location" name="location" aria-label="location"
                                                aria-describedby="location" required/>
                                        </div>
                                        <div class="form-group">
                                            <label class="form-label" for="email">E-Mail</label>
                                            <input type="email" class="form-control dt-full-email" id="email"
                        ...
                        <div class="modal modal-slide-in update_user_modal fade" id="modals-slide-in">
                            <div class="modal-dialog">
                                <form class="update-new-user modal-content pt-0">
                                    ...
                                    <div class="modal-body flex-grow-1">
                                        <div class="form-group">
                                            <label class="form-label" for="ulocation">location</label>
                                            <input type="text" class="form-control" id="ulocation"
                                                placeholder="location" name="ulocation" aria-label="ulocation"
                                                aria-describedby="ulocation" required/>
                                        </div>
                                        <div class="form-group">
                                            ...
                                            <input type="email" class="form-control" id="uemail"
                                                ...
                                                aria-describedby="uemail" required/>
                                        </div>
    ...
    <!-- BEGIN: Page JS-->
    <script src="{{ URL::asset('vendor/datatrans/js/tables/datatrans-location.js') }}"></script>
    <!-- END: Page JS-->
    ...
    $(function() {
        ...
        $(document).on("click", ".userupdate_new", function()  {
            var id = $(this).data('id');
            var url = 'datatrans-location-update/' + ($(this).data('id'));
            $("#ulocation").val($(this).data('name'));
        ...
        $(document).on("click", ".delete_locationdata", function(e) {
            var url = 'datatrans-location-delete/' + $(this).data('id');
            e.preventDefault();
            $.ajax({
                headers: {
                    'X-CSRF-TOKEN': $('meta[name="csrf-token"]').attr('content')
        ...
        $(document).on("click", ".location_google_calendar", function(){
