...
<body class="vertical-layout vertical-menu-modern  navbar-floating footer-static" data-open="click" data-menu="vertical-menu-modern" data-col="">
            ...
            <div class="content-body">
                ...
                <section class="horizontal-wizard">
                    <div class="bs-stepper horizontal-wizard-example">
                        <div class="bs-stepper-header d-md-flex d-none">
                            <div class="step" data-target="#service-service">
                                <button type="button" class="step-trigger">
                                    <span class="bs-stepper-label">
                                        <span class="bs-stepper-title pb-3">1. {{ trans('locale.FrontendserviceOne') }}</span>
                                    </span>
                                </button>
                            ...
                            <div class="step" data-target="#service-time">
                                <button type="button" class="step-trigger">
                                    <span class="bs-stepper-label">
                                        <span class="bs-stepper-title pb-3">2. {{ trans('locale.Frontendtime') }}</span>
                                    </span>
                                </button>
                                <div class="progress-step"></div>
                            </div>
                            ...
                            <div class="step" data-target="#service-detail">
                                <button type="button" class="step-trigger">
                                    <span class="bs-stepper-label">
                                        <span class="bs-stepper-title pb-3">3. {{ trans('locale.FrontendDetails') }}</span>
                                    </span>
                                </button>
                                <div class="progress-step"></div>
                            </div>
                            ...
                            <div class="step" data-target="#service-payment">
                                <button type="button" class="step-trigger">
                                    <span class="bs-stepper-label">
                                        <span class="bs-stepper-title pb-3">4. {{ trans('locale.FrontendPayment') }}</span>
                                    </span>
                                </button>
                                <div class="progress-step"></div>
                            </div>
                            <div class="step" data-target="#page-done">
                                <button type="button" class="step-trigger">
                                    <span class="bs-stepper-label">
                                        <span class="bs-stepper-title pb-3">5. {{ trans('locale.FrontendDoneFive') }}</span>
                                    </span>
                                </button>
                                <div class="progress-step"></div>
                            </div>
                        ...
                        <div class="bs-stepper-content">
                            <div id="service-service" class="content">
                                <div class="content-header">
                                    <span class="content-header-explain">{{ trans('locale.FrontendSelectService') }}</span>
                                </div>
                                <form>
                                    <div class="row">
                                        <div class="col-md-6 row">
                                            <div class="form-group col-md-6">
                                                <label class="form-label service-label-color" for="Masseuse">{{ trans('locale.FrontendLocation') }}</label>
                                                <select class="form-select w-100" name="location" id="location" aria-label="location" required>
                                                    <option value="">{{ trans('locale.FrontendLocation') }}</option>
                                            ...
                                            <div class="form-group col-md-6">
                                                <label class="form-label service-label-color" for="Masseuse">{{ trans('locale.FrontendEmployeeName') }}</label>
                                                <select class="form-select w-100" name="employee" id="employee" aria-label="employee" required>
                                                    <option value="">{{ trans('locale.FrontendEmployeeName') }}</option>
                                        ...
                                        <div id="service_first_page" class="col-md-6 row">
                                            <div class="form-group col-md-6">
                                                <label class="form-label service-label-color" for="service">{{ trans('locale.FrontendService') }}</label>
                                            ...
                                            <div class="form-group col-md-6" style="visibility: hidden;">
                                                <label class="form-label service-label-color" for="Masseuse">{{ trans('locale.FrontendCategory') }}</label>
                                                <select class="form-select w-100" name="category_name" id="category_name" aria-label="category_name" required>
                                                    <option value="category" selected>{{ trans('locale.FrontendCategory') }}</option>
                                    ...
                                    <div class="row">
                                        <div class="col-12 col-md-3 form-group">
                                            <label for="pd-default">{{ trans('locale.FrontendSelectDate') }}</label>
                                            <input type="text" class="form-control pickadate" id="select_date" name="select_date" placeholder="{{ trans('locale.FrontendDate') }}" />
                                        </div>
                                    </div>
                                </form>
                                ...
                                <div class="d-flex justify-content-between mt-4 btn-pagenation pt-4">
                                    <button class="btn btn-outline-secondary btn-prev invisible" disabled>
                                        <span class="d-sm-inline-flex d-none">{{ trans('locale.FrontendPrevious') }}</span>
                                    </button>
                                    <button class="btn btn-next-bgcolor btn-next-serivce-select">
                                        <span class="d-flex align-items-center btn-next-font">{{ trans('locale.FrontendContinue') }}</span>
                                    </button>
                                </div>
                            </div>
                            <div id="service-time" class="content">
                                <div class="content-header">
                                    <span class="content-header-explain">
                                        {{ trans('locale.FrontendTimeOne') }} <b class="service__name"></b> {{ trans('locale.FrontendTimeTwo') }}<br> {{ trans('locale.FrontendTimeThree') }}
                                ...
                                <div class="d-flex justify-content-between  mt-4 btn-pagenation pt-4">
                                    <button class="btn btn-prev btn-back-bgcolor">
                                        <span class="align-middle d-flex">{{ trans('locale.FrontendBACK') }}</span>
                                    </button>
                            ...
                            <div id="service-detail" class="content">
                                <div class="content-header">
                                    <span class="content-header-explain content-header-explain-text">
                                         {{ trans('locale.FrontendDetailsOne') }} <b class="service__name"></b> um <b class="service__time"></b> . <div class="d-none">{{ trans('locale.FrontendDetailsTwo') }} <b>CHF</b><b class="service__price"></b> . </div>
                                        <br>{{ trans('locale.FrontendDetailsThree') }}
                                    </span>
                                </div>
                                <form>
                                    <div class="row">
										 <div class="form-group col-md-4">
                                            <label class="form-label service-label-color" for="username">{{ trans('locale.FrontendDetailsusername') }}</label>
                                            <input type="text" id="username" name="username" class="form-control" placeholder="" required/>
                                        </div>
                                        
                                        <div class="form-group col-md-4">
                                            <label class="form-label service-label-color" for="phone_num">{{ trans('locale.FrontendDetailsPhone') }}</label>
                                            <input type="tel" name="phone_num" id="phone_num" class="form-control phone_num" value="" placeholder="" required>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="form-label service-label-color" for="client_email">{{ trans('locale.FrontendDetailsEmail') }}</label>
                                            <input type="email" name="client_email" id="client_email" class="form-control" placeholder="" required/>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="form-label service-label-color" for="client_name">{{ trans('locale.FrontendDetailsSurname') }}</label>
                                            <input type="text" id="client_name" name="client_name" class="form-control" placeholder="" required/>
                                        </div>
                                       
                                        <div class="form-group col-md-4">
                                            <label class="form-label service-label-color" for="street">{{ trans('locale.FrontendDetailsstreet') }}</label>
                                            <input type="text" id="street" name="street" class="form-control" placeholder="" required/>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="form-label service-label-color" for="PLZ">{{ trans('locale.FrontendDetailsPLZ') }}</label>
                                            <input type="text" name="PLZ" id="PLZ" class="form-control" placeholder="" required/>
                                        </div>
                                        <div class="form-group col-md-4">
                                            <label class="form-label service-label-color" for="city">{{ trans('locale.FrontendDetailsCity') }}</label>
                                            <input type="text" name="city" id="city" class="form-control" placeholder="" required/>
                                        </div>
                                    </div>
                                    <div class="row">
                                        <div class="form-group col-md-12">
                                            <label class="form-label service-label-color" for="client_comment">{{ trans('locale.FrontendDetailsComment') }}</label>
                                            <textarea type="text" id="client_comment" name="client_comment" class="form-control" placeholder="" ></textarea>
                                        </div>
                                    </div>
                                </form>
                                <div class="d-flex justify-content-between btn-pagenation pt-4">
                                    ...
                                    <button class="btn btn-next-bgcolor btn-next">
                                        <span class="align-middle d-flex">{{ trans('locale.FrontendBOOK') }}</span>
                                    </button>
                            ...
                            <div id="service-payment" class="content">
                                <div class="content-header">
                                    <span class="content-header-explain">
                                        {{ trans('locale.FrontendPaymentOne') }}
                                    </span>
                                </div>
                                <form>
                                    <div class="row">
                                        <div class="datatrans-payment-nav">
                                            <div class="datatrans-box datatrans-list">
                                                <label>
                                                    ...
                                                    <span> {{ trans('locale.FrontendPaymentTwo') }}</span>
                                                </label>
                                            </div>
                                            <div class="datatrans-box datatrans-list {{$setpayment != 1 ? 'd-none' : ''}}" >
                                                <label>
                                                    <input type="radio" class="datatrans-payment" name="payment_method_datatrans" id="online_payment" value="online">
                                                    <span>
                                                        {{ trans('locale.FrontendPaymentThree') }}
                                                    </span>
                                                    
                                                    <div class="paymentForm_payment_page" style="display: none;">
                                                            <button type="button" class="btn btn-primary mt-2" id="go_pay_button" data-submerchantid="{{$submerchantID}}" data-own_id="{{$id}}">
                                                            {{ trans('locale.FrontendPay') }}
                                                            </button>
                                                    </div>
                                                </label>
                                            </div>
                                    ...
                                    <input type="hidden" id="csrf_token_hidden" name="csrf_token_hidden" value="{{ csrf_token() }}">
                                </form>
                                <div class="d-flex justify-content-between btn-pagenation pt-4">
                                    <button class="btn btn-next-bgcolor btn-prev">
                                        <span class="align-middle d-flex">{{ trans('locale.FrontendBACK') }}</span>
                                    </button>
                                    <button class="btn btn-submit btn-next-bgcolor btn_final_submit btn_final_submit_click" data-own_id="{{$id}}">{{ trans('locale.FrontendBOOK') }}</button>
                                </div>
                            </div>
    ...
    <!-- END: Content-->
        <script>
            var emorder = '@foreach ($emorders as $emorder)"{{$emorder->service_name}}:{{$emorder->employee}}:{{$emorder->datatrans_day}}:{{$emorder->datatrans_time}}",@endforeach';
            var emorders = emorder.split(',');
            console.log('emorders', emorders);
            ...
            var calendar_events = '@foreach ($events as $event)"{{strtotime($event->start->dateTime)}},{{strtotime($event->end->dateTime)}}".@endforeach';
			
        </script>
    
    {{-- Footer --}}

    @include('layouts.footerservice')

    <script>
        function getservice(locationname, employeename){
            var id = {{$id}};
            var url = '/getservice';
            $.ajax({
                headers: {
                ...
                type: 'post',
                url: url,
                data: {locationname : locationname, employeename : employeename, id : id},
                success: function(data) {
                    if(data){
                        ...
                        var locationlists = [], employeelists = [], servicelists = [], categorylists = [], data;
                        for(var i = 0; i<locations.length; i++){
                            locationlists.push("<option value='"+locations[i].location+ "'>" + locations[i].location + "</option>");
                        }

                        for(var i = 0; i<employees.length; i++){
                            employeelists.push("<option value='"+employees[i].employee+ "'>" + employees[i].employee + "</option>");
                        }
                        ...
                        for(var i = 0; i<categories.length; i++){
                            categorylists.push("<option value='"+categories[i].category+ "'>" + categories[i].category + "</option>");
                        }

                        data = "<div class='form-group col-md-6'><label class='form-label service-label-color' for='service'>{{ trans('locale.FrontendService') }}</label><select class='form-select w-100' name='service_name' id='service_name' aria-label='service_name' required><option value=''>{{ trans('locale.FrontendSelectService') }}</option>"+ servicelists +"</select></div><div  style='visibility: hidden;' class='form-group col-md-6'><label class='form-label service-label-color' for='Masseuse'>{{ trans('locale.FrontendCategory') }}</label><select class='form-select w-100' name='category_name' id='category_name' aria-label='category_name'><option value='category' selected>{{ trans('locale.FrontendCategory') }}</option>"+ categorylists +"</select></div>"
                        $('#service_first_page').html(data);
        ...
        $(document).on('change', '#location', function(e){
            ...
            var employeename = $('#employee option:selected').val();
            getservice(locationname, employeename)
        });
