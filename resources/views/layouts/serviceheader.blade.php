<head>
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('vendor/datatrans/vendors/css/extensions/toastr.min.css') }}">
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('vendor/datatrans/vendors/css/forms/wizard/bs-stepper.min.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('vendor/datatrans/vendors/css/pickers/pickadate/pickadate.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('vendor/datatrans/vendors/css/pickers/flatpickr/flatpickr.min.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('vendor/datatrans/vendors/css/tables/datatable/dataTables.bootstrap4.min.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('vendor/datatrans/vendors/css/tables/datatable/responsive.bootstrap4.min.css') }}">
    <link rel="stylesheet" type="text/css"
        href="{{ asset('vendor/datatrans/vendors/css/tables/datatable/buttons.bootstrap4.min.css') }}">
    <!-- END: Vendor CSS-->
    ...
    <link rel="stylesheet" type="text/css"
        href="{{ asset('vendor/datatrans/css/plugins/extensions/ext-component-toastr.css') }}">
    <!-- END: Page CSS-->
    ...
    <style>
        ...
        table>tbody>tr td:first-child:hover {
            color: <?php echo $setcolor ? $setcolor : (!isset($setcolor) ? '#f4662f' : $setcolor); ?>;
        }
        ...
        .show>.btn-primary.dropdown-toggle {
            background-color: <?php echo $setcolor ? $setcolor : (!isset($setcolor) ? '#f4662f' : $setcolor); ?>;
            border-color: <?php echo $setcolor ? $setcolor : (!isset($setcolor) ? '#f4662f' : $setcolor); ?>;
        }
        ...
        .text-primary {
            color: <?php echo $setcolor ? $setcolor : (!isset($setcolor) ? '#f4662f' : $setcolor); ?> !important;
        }

        .bg-primary {
            background-color: <?php echo $setcolor ? $setcolor : (!isset($setcolor) ? '#f4662f' : $setcolor); ?> !important;
        }
        ...
        .btn-next-bgcolor:hover,
        .btn-back-bgcolor:hover {
            color: #fff;
        }
        ...
        .picker--opened .picker__holder {
            max-width: 320px;
            max-height: 300px;
            background: <?php echo $setcolor ? $setcolor : (!isset($setcolor) ? '#f4662f' : $setcolor); ?>;
            border-radius: 5px;
        }
        ...
        .picker__nav--next::before {
            border-left: 6px solid <?php echo $setcolor ? $setcolor : (!isset($setcolor) ? '#f4662f' : $setcolor); ?> !important;
        ...
        .picker__nav--prev::before {
            border-right: 6px solid <?php echo $setcolor ? $setcolor : (!isset($setcolor) ? '#f4662f' : $setcolor); ?> !important;
        ...
        .datatrans-day {
            ...
            color: white;
            font-weight: bold;
            border: 1px solid <?php echo $setcolor ? $setcolor : (!isset($setcolor) ? '#f4662f' : $setcolor); ?>;
            display: block;
            min-width: 0;
            width: 100%;
            margin: 1.5px 0;
        ...
        .datatrans-hour:hover {
            border: 2px solid <?php echo $setcolor ? $setcolor : (!isset($setcolor) ? '#f4662f' : $setcolor); ?>;
            color: <?php echo $setcolor ? $setcolor : (!isset($setcolor) ? '#f4662f' : $setcolor); ?>;
        }
        ...
        *[data-usn-if] {
        ...
        .select2-container--default .select2-selection--single:focus {
            outline: 0;
            border-color: <?php echo $setcolor ? $setcolor : (!isset($setcolor) ? '#f4662f' : $setcolor); ?> !important;
        ...
        .main-menu.menu-light .navigation>li ul .active {
            background: linear-gradient(118deg, <?php echo $setcolor ? $setcolor : (!isset($setcolor) ? '#f4662f' : $setcolor); ?>, <?php echo $setcolor ? $setcolor : (!isset($setcolor) ? '#f4662f' : $setcolor); ?>70);
            box-shadow: 0 0 10px 1px <?php echo $setcolor ? $setcolor : (!isset($setcolor) ? '#f4662f' : $setcolor); ?>70;
            border-radius: 4px;
            z-index: 1;
        }
