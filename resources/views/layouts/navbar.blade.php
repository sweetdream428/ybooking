            ...
            <li class="nav-item dropdown dropdown-user">
                <a class="nav-link dropdown-toggle dropdown-user-link" id="dropdown-user" href="javascript:void(0);" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                    <div class="user-nav d-sm-flex">
                        <span class="user-name font-weight-bolder rounded-pill px-2 justify-content-center text-center" style="color:white;line-height: 2.3;">
                            {{Auth::user()->name}}
                        </span>
                    </div>
                </a>
                <div class="dropdown-menu dropdown-menu-right d-flx flex-column py-1 px-0" aria-labelledby="dropdown-user">
                        ...
                        <div class="dropdown-items justify-content-center d-flex">
                            <form method="get" action="{{ route('signout') }}" class="my-2">
                                @csrf
                                <a href="/datatrans-service/{{Auth::user()->name}}" class="mb-1 d-block">
                                   Visit Page
                                </a>
                                <a class="pt-1" href="{{ route('signout') }}"
