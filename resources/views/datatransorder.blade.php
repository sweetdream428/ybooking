                            ...
                            <table class="data-list-table table">
                                ...
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>{{date('j F Y', strtotime(str_replace(':', '-', $order->datatrans_day))) }}</td>
                                        ...
                                        <td>
                                            <button class="dropdown-item userupdate_new d-inline" data-id="{{$order->id}}" data-service_name="{{$order->service_name}}" data-category_name="{{$order->category_name}}" data-location="{{$order->location}}" data-employee="{{$order->employee}}" data-timezone_name="{{$order->timezone_name}}" data-datatrans_day="{{str_replace(':', '-', $order->datatrans_day)}}" data-datatrans_time="{{$order->datatrans_time}}" data-client_name="{{$order->client_name}}" data-phone_num="{{$order->phone_num}}" data-client_email="{{$order->client_email}}" data-client_comment="{{$order->client_comment}}" data-datatrans_payment="{{$order->datatrans_payment}}" data-status="{{$order->status}}">
                                ...
                                <form class="update-new-user modal-content pt-0">
                                    ...
                                    <div class="modal-body flex-grow-1">
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="ulocation" class="form-control" id="ulocation" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <select name="uemployee" class="form-control" id="uemployee" required>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="text" class="form-control pickadate_order udatatrans_day" id="udatatrans_day" name="udatatrans_day" required/>
                                        </div>
                                        <div class="form-group">
